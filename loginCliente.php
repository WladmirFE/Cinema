...
if(isset ($_SESSION['idClienteLogado'])){
    header("Location: clienteAddEdit.php");
}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="loginControleCliente.php" method="post">

                                        <?php

                                        if (isset($_GET['erro'])){
                                            echo"
                                            <p class='text-danger text-center''> E-Mail ou senha incorretos!</p>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="forgot-password.html">Esquece a senha?</a>
                                    </div>
                                </div>
                            </div>
                        </div>

...
$obj = NULL;
if(isset($_GET['id'])){
    $obj = FilmeDAO::getInstance()->getById($_GET['id']);
}
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <form method="POST" action="controle/filmeControl.php">
                                    ...
                                    <div>
                                        Descriçao:
                                        <input type="text" name="descricao" id="descricao" value="<?php echo $obj == NULL?"":$obj->getDescricao(); ?>" class="form-control mb-2"/>

                                    </div>

                                    <div>
                                        Foto:
                                        <input type="text" name="foto" id="foto" value="<?php echo $obj == NULL?"":$obj->getFoto(); ?>" class="form-control mb-2"/>
